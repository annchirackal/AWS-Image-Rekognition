...
import javax.jms.Session;
import javax.jms.TextMessage;
public class Instance1Application{
	public static void main(String[] args) throws IOException,JMSException,InterruptedException {
		SpringApplication.run(Instance1Application.class, args);
		
 	   
 	
		AWSCredentials awsCreds = new ProfileCredentialsProvider("default").getCredentials();
        ...
        try {
           AmazonS3 s3Client = AmazonS3ClientBuilder.standard().withRegion("your region")
